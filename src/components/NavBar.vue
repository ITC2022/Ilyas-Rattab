<template>
  <nav class="navbar" :class="{ scrolled: isScrolled }">
    <div class="nav-inner">
      ...
      <ul class="nav-links">
        <li v-for="item in navItems" :key="item.id">
          <a href="#" class="nav-link" :class="{ active: activeSection === item.id }"
      ...
      <div class="nav-controls">
        <div class="lang-switcher">
          <button v-for="lang in langs" :key="lang" class="lang-btn" :class="{ active: currentLang === lang }"
    ...
    <div class="mobile-nav" :class="{ open: mobileOpen }">
      <a v-for="item in navItems" :key="item.id" href="#" class="mobile-link" @click.prevent="scrollTo(item.id)">
        {{ item.label }}
      </a>
